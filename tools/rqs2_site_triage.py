...
SITE_LAYERS = [
    # ── XAUUSD-M5 ────────────────────────────────────────────────────────
    dict(layer="S330", card="XAUUSD-M5", side="both", geom=("atr", 1.5, 1.5, 14),
         hold=48, n=49, wr=69.4, pf=1.91, src="S330_SessionORBFade_Xauusd_M5_90.md"),
    dict(layer="S328", card="XAUUSD-M5", side="short", geom=("atr", 1.6, 1.05, 14),
         hold=48, n=41, wr=78.0, pf=2.33, src="S328_RSI21FadeShort_Xauusd_M5H1_94.md"),
    dict(layer="S334", card="XAUUSD-M5", side="short", geom=("atr", 1.5, 1.5, 14),
         hold=60, n=47, wr=61.7, pf=1.61, src="S334_MeanReversionShort_XauusdEurusd_M5_84.md"),
    dict(layer="S335", card="XAUUSD-M5", side="long", geom=("atr", 1.4, 1.9, 14),
         hold=48, n=51, wr=62.7, pf=2.22, src="S335 (registry)"),
    dict(layer="S326", card="XAUUSD-M5", side="both", geom=("pip", 60.0, 22.0),
         hold=24, n=77, wr=84.4, pf=1.66, src="S326_StreakReversal_…_92_ACCEPTED.md"),

    # ── XAUUSD-M15 ───────────────────────────────────────────────────────
    dict(layer="S333", card="XAUUSD-M15", side="long", geom=("atr", 1.5, 1.8, 14),
         hold=64, n=51, wr=62.8, pf=2.30, src="census row 9 (already v2.4: z=1.98)"),
    dict(layer="S332", card="XAUUSD-M15", side="both", geom=("pip", 190.0, 285.0),
         hold=64, n=53, wr=60.4, pf=1.90, src="S332_SqueezeBankFilters_…_91.md"),
    dict(layer="S324", card="XAUUSD-M15", side="long", geom=("pip", 95.0, 60.0),
         hold=48, n=62, wr=87.1, pf=1.92, src="S324_LiquiditySweepReversal_…_93.md"),
    dict(layer="S322", card="XAUUSD-M15", side="long", geom=("pip", 78.6, 101.7),
         hold=96, n=51, wr=60.8, pf=1.89, src="S322_IchimokuKumo_Xauusd_M15_86.md"),
    dict(layer="S323", card="XAUUSD-M15", side="long", geom=("atr", 1.8, 1.5, 14),
         hold=96, n=92, wr=69.6, pf=1.64, src="S323_SRPullbackGolden_…_88.md"),
    dict(layer="S344", card="XAUUSD-M15", side="short", geom=("pip", 220.0, 340.0),
         hold=64, n=92, wr=64.13, pf=2.078, src="S344_BrooksTrendFromOpen_…_rqs91.md"),
    dict(layer="S345", card="XAUUSD-M15", side="long", geom=("atr", 1.35, 1.9, 14),
         hold=64, n=101, wr=62.38, pf=2.299, src="S345_BrooksReversalDay_…_rqs90.md"),
    dict(layer="S310", card="XAUUSD-M15", side="long", geom=("pip", 150.0, 220.0),
         hold=64, n=45, wr=60.0, pf=1.74, src="S310_EndOfMonthDriftRevival_…_87.md"),
    dict(layer="S312", card="XAUUSD-M15", side="long", geom=("pip", 295.0, 295.0),
         hold=48, n=68, wr=60.9, pf=2.50, src="S312_MidMonthDrift_…_89_ACCEPTED.md"),

    # ── XAUUSD-M30 ───────────────────────────────────────────────────────
    dict(layer="S333", card="XAUUSD-M30", side="long", geom=("atr", 1.5, 1.8, 14),
         hold=48, n=42, wr=66.7, pf=2.48, src="census row 11 (already v2.4: z=2.27)"),
    dict(layer="S313", card="XAUUSD-M30", side="both", geom=("atr", 3.2, 2.15, 14),
         hold=48, n=67, wr=67.8, pf=3.27, src="S313_SqueezeBreakout_Xauusd_H1M30_92.md"),
    dict(layer="S324", card="XAUUSD-M30", side="short", geom=("pip", 130.0, 82.0),
         hold=48, n=75, wr=82.7, pf=1.59, src="S324_LiquiditySweepReversal_…_93.md"),
    dict(layer="S321", card="XAUUSD-M30", side="both", geom=("atr", 1.7, 1.6, 14),
         hold=48, n=78, wr=65.4, pf=1.75, src="S321_MARibbonRevival_…_88_ACCEPTED.md"),
    dict(layer="S326", card="XAUUSD-M30", side="both", geom=("pip", 120.0, 44.0),
         hold=24, n=54, wr=79.6, pf=1.42, src="S326_StreakReversal_…_92_ACCEPTED.md"),
    dict(layer="S323", card="XAUUSD-M30", side="long", geom=("atr", 2.1, 1.3, 14),
         hold=48, n=140, wr=77.1, pf=1.75, src="S323_SRPullbackGolden_…_88.md"),
    dict(layer="S312", card="XAUUSD-M30", side="long", geom=("pip", 295.0, 295.0),
         hold=36, n=148, wr=61.6, pf=1.94, src="S312_MidMonthDrift_…_89_ACCEPTED.md"),

    # ── XAUUSD-H1 ────────────────────────────────────────────────────────
    dict(layer="S333", card="XAUUSD-H1", side="long", geom=("atr", 1.5, 1.8, 14),
         hold=36, n=74, wr=62.2, pf=1.85, src="census row 6 (already v2.4: z=2.10)"),
    dict(layer="S313", card="XAUUSD-H1", side="both", geom=("atr", 3.2, 2.15, 14),
         hold=36, n=59, wr=67.8, pf=3.27, src="S313_SqueezeBreakout_Xauusd_H1M30_92.md"),
    dict(layer="S328", card="XAUUSD-H1", side="short", geom=("atr", 1.6, 1.05, 14),
         hold=36, n=34, wr=70.6, pf=2.43, src="S328_RSI21FadeShort_Xauusd_M5H1_94.md"),
    dict(layer="S323", card="XAUUSD-H1", side="long", geom=("atr", 1.8, 1.7, 14),
         hold=36, n=35, wr=71.4, pf=2.14, src="S323_SRPullbackGolden_…_88.md"),
    dict(layer="S335", card="XAUUSD-H1", side="long", geom=("atr", 1.4, 1.9, 14),
         hold=36, n=49, wr=61.2, pf=1.85, src="S335 (registry)"),
    dict(layer="S312", card="XAUUSD-H1", side="long", geom=("pip", 395.0, 395.0),
         hold=24, n=125, wr=60.9, pf=2.04, src="S312_MidMonthDrift_…_89_ACCEPTED.md"),

    # ── XAUUSD-H4 ────────────────────────────────────────────────────────
    dict(layer="S340", card="XAUUSD-H4", side="both", geom=("atr", 1.5, 1.7, 14),
         hold=24, n=61, wr=65.6, pf=2.13, src="S340_BrooksMicroChannel_…_rqs93.md"),
    dict(layer="S332", card="XAUUSD-H4", side="both", geom=("pip", 350.0, 500.0),
         hold=24, n=70, wr=65.7, pf=1.99, src="S332_SqueezeBankFilters_…_91.md"),

    # ── EURUSD ───────────────────────────────────────────────────────────
    dict(layer="S334", card="EURUSD-M5", side="short", geom=("atr", 1.5, 1.5, 14),
         hold=60, n=45, wr=66.7, pf=1.62, src="S334_MeanReversionShort_…_84.md"),
    dict(layer="S326", card="EURUSD-M15", side="both", geom=("pip", 26.0, 8.0),
         hold=24, n=98, wr=81.6, pf=1.32, src="S326_StreakReversal_…_92_ACCEPTED.md"),
    dict(layer="S345", card="EURUSD-M30", side="short", geom=("atr", 1.35, 1.9, 14),
         hold=48, n=40, wr=62.50, pf=2.382, src="S345_BrooksReversalDay_…_rqs90.md"),
]
