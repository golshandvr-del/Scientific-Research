...
THRS = (1.5, 2.0, 2.5, 3.0, 3.5)   # آستانهٔ z — بسطِ مرز پس از دیدنِ یکنواییِ M15
KS = (0.8, 1.3, 2.1, 3.4)          # ضریبِ SL — فیبوناچی‌وار (0.8,1.3,2.1,3.4)
RRS = (1.0, 1.5, 2.0)              # نسبتِ TP/SL — هرگز <1
# ⚠️ بسطِ شبکه (گامِ ۳) پس از مشاهدهٔ روندِ یکنواختِ سه‌محوره در M15:
# حاشیه با عمقِ کشش، پهنای SL و سخاوتِ RR یکنوا بهبود می‌یافت و تنها خانهٔ
# مثبت روی **مرزِ** شبکه بود ⇒ مرز باز شد. مشروع چون در نیمهٔ اولیم و
# کلِ فضا (۵×۴×۳×۲ جهت = ۱۲۰ سلول×TF) در n_trials پیش‌ثبت شمرده می‌شود.
