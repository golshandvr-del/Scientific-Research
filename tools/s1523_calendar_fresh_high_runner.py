# -*- coding: utf-8 -*-
"""S1523 — سقفِ تازهٔ تقویم‌همتا (۳۰ روز معاملاتی؛ LB per TF) ⇒ LONG | D1/H12/H6/H4.
پیش‌ثبت: results/S1523_PREREG_CalendarMatchedFreshHigh_Xauusd_D1H12H6H4.md (قبل از این کد).
...
OUT = 'results/_s1523'
CARDS = ['XAUUSD_D1', 'XAUUSD_H12', 'XAUUSD_H6', 'XAUUSD_H4']
LB_BY_CARD = {'XAUUSD_D1': 30, 'XAUUSD_H12': 60, 'XAUUSD_H6': 120, 'XAUUSD_H4': 180, 'XAUUSD_H8': 90}
N_TRIALS = 30
...
def main():
    ...
    print(f'S1523 calendar-matched fresh high | LB_BY_CARD={LB_BY_CARD} | '
    ...
    for card in cards:
        ...
        print(f'  {card}: LOOKBACK={LOOKBACK} (30 trading days)', flush=True)
        try:
