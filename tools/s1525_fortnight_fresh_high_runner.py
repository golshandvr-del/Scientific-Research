# -*- coding: utf-8 -*-
"""S1525 — سقفِ تازهٔ دوهفته‌ای (۱۰ روز معاملاتی؛ LB per TF) ⇒ LONG | H4/H6/H8.
پیش‌ثبت: results/S1525_PREREG_FortnightFreshHigh_Xauusd_H4H6H8.md (قبل از این کد).
...
OUT = 'results/_s1525'
CARDS = ['XAUUSD_H4', 'XAUUSD_H6', 'XAUUSD_H8']
LB_BY_CARD = {'XAUUSD_H4': 60, 'XAUUSD_H6': 40, 'XAUUSD_H8': 30}  # 10 trading days
N_TRIALS = 40
...
def main():
    ...
    print(f'S1525 fortnight fresh high | LB_BY_CARD={LB_BY_CARD} | '
    ...
    for card in cards:
        ...
        print(f'  {card}: LOOKBACK={LOOKBACK} (10 trading days)', flush=True)
        try:
