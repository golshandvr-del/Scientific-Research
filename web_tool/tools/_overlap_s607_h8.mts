...
const out = {
  ...
  window: {
    ...
    scope_limit:
      'پنجرهٔ ۱۲۰۰ کندل (≈۱.۳ سالِ معاملاتیِ H8) انتخاب شد چون اجرای غلتانِ پنج ' +
      'لایه با پنجرهٔ ۳۰۰۰ِ سندِ S966 اندازه‌گیری شد و تایم‌اوت داد (O(n²)). ' +
      '⇒ این اعداد **مستقیماً** با اعدادِ overlap_s950_s965_s966_h8.json (پنجرهٔ ' +
      '۳۰۰۰) مقایسه‌پذیر نیستند؛ فقط نسبت‌های درونِ همین پنجره معتبرند.',
  },
  counts: {
