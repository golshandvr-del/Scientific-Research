...
/**
 * زمینهٔ کانالِ زندهٔ آخرین کندلِ بسته‌شده، **همراه با شناسهٔ سگمنت و تاریخِ
 * شکست‌های پیشینِ همان سگمنت**.
 *
 * ⚠️ چرا شناسهٔ سگمنت لازم است؟ پایتون قاعدهٔ `_first_per_seg` را اعمال می‌کند:
 * «فقط نخستین شکست در هر زمینه» — تا یک الگو چند سیگنالِ همبسته نپاشد. بدونِ
 * این قاعده، شکستِ دوم و سومِ همان کانال هم سیگنال می‌شود. آزمونِ برابری این را
 * به‌صورتِ ۱۹ سیگنالِ اضافیِ یورو کشف کرد.
 *
