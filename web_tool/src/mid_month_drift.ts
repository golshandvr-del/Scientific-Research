    ...
    if (!midFiltersPass(filt)) {
      return {
        ...
        reason: `اکنون در یکی از «روزهای درایوِ میانهٔ ماه» (روزهای ۱۰، ۱۳ یا ۲۰ تقویمی) و ساعتِ ` +
          `${toIran(utcHour)} به وقتِ ایران (سشنِ آسیا→لندن، ${MID_IRAN_RANGE}) هستیم — پنجرهٔ «درایوِ میانهٔ ماهِ طلا». ` +
          `اما فیلترِ کیفیت هنوز تأیید نشده. برای صدورِ سیگنالِ خرید باید: روندِ کلان صعودی شود (قیمت بالای EMA200). ` +
          `(لایهٔ زمان-محورِ S312 با فیلترِ رژیم ⇒ RQS+ ۸۹.۳، WR ۶۱٪، PF ۲.۵۰ — قوی‌ترین t-statِ تقویمیِ پروژه.)`,
      }
    }
    return {
      state: 'ENTRY', isMidWindow: true, utcHour, slDist, tpDist,
      reason: `اکنون در یکی از «روزهای درایوِ میانهٔ ماه» (روزهای ۱۰، ۱۳ یا ۲۰ تقویمی) و ساعتِ ` +
        `${toIran(utcHour)} به وقتِ ایران (سشنِ آسیا→لندن) هستیم و فیلترِ کیفیت (روندِ کلانِ صعودی بالای EMA200) تأیید شد. ` +
        `این پنجره درایوِ صعودیِ «بازتوازنِ نهادی/ETF و تسویهٔ میان‌ماه» را شکار می‌کند. ` +
        `سیگنالِ خرید (LONG) با RR متقارن: TP ${MID_TP_PIP}pip و SL ${MID_SL_PIP}pip. این پیکربندی در بک‌تستِ ` +
        `رویداد-محور RQS+ = ۸۹.۳ داد (هر ۶ گیت، در هر دو نیمهٔ IS/OOS مثبت — سند S312). ` +
        `مستقل از لایهٔ اولِ ماه (S306) و پایانِ ماه (S310): همپوشانیِ معاملاتی صفر.`,
    }
  }
