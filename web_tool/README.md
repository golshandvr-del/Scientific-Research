...
> ## 🏆 برندهٔ سودِ خالص که در سایت اعمال شده: **S65 (Adaptive-TP + Kelly Router)**
> سایت اکنون **هر سه بُعدِ برندهٔ سودِ خالص** را پیاده کرده است (نه فقط S63 پایه):
> **(۱) کجا وارد شویم** (S63/L36 — Router رژیم-محور)، **(۲) با چه حجمی** (S64/L38 —
> حجمِ Kelly رژیم-آگاه)، **(۳) تا کجا سود بگیریم** (S65/L39 — TPِ رژیم-محور).
> در بک‌تستِ walk-forward روی ۱۵۰٬۰۰۰ کندل، این ترکیب سودِ خالص را از **۲۹۴۹$ به
> ۶۰۸۲$ (+۱۰۶٪)** رساند — با آنکه WR از ۶۲٪ به ۵۱٪ افت کرد. **این خودْ اثباتِ قانونِ
> شمارهٔ ۱ است: WR مهم نیست، سودِ خالص مهم است.**
