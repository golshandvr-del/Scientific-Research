...
> معیارِ موفقیتِ کلِ محصول **فقط «سودِ خالصِ بیشتر»** است؛ WR هدف نیست، اما
> **WR هر لایهٔ فعال باید حداقل ۴۰٪ باشد.** PF و فرکانس هدف نیستند.
...
> ## 🥇 رکوردِ فعلیِ سخت‌گیرانه: **+$221,895** (تعریف رسمی = XAUUSD + EURUSD)
> **قانون شمارهٔ ۱:** سود خالص تنها تابع هدف است؛ WR≥40٪ کف غیرقابل‌نقض هر لایه است.
> آخرین چرخه، S91 با WR=27٪ را حذف و **S164 EURUSD Pre-Month-End Fix Reversal** را افزود:
> Short در سومین روز کاری مانده به پایان ماه، ساعت ۱۳ UTC، SL15/TP20/حداکثر ۱۲ کندل.
> بک‌تست: +$3,473، WR=60.7٪، PF=1.71، هر دو نیمه و هر چهار WF مثبت و WR≥40.
> سایت اکنون حالت‌های خنثی/نزدیک‌شدن/ورود Short/مدیریت را برای این پنجره نمایش می‌دهد.
> جزئیات: [`../results/EURUSD_PreMonthEndFixReversal_NetProfit_221895.md`](../results/EURUSD_PreMonthEndFixReversal_NetProfit_221895.md).
...
- 🪙 **دو دارایی:** XAUUSD (`router.ts`) و EURUSD (`eurusd_router.ts`) با سه جریان S73، S143 و **S164**. DXY/AUDUSD حذف شدند. **رکورد سخت‌گیرانهٔ کل = +$221,895.**
