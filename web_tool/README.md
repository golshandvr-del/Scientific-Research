...
> این سایت یک **دستیارِ تصمیمِ چند-دارایی و ۴-حالته** است: برای هر دارایی
> (`XAUUSD`, `DXY`, `EURUSD`, `AUDUSD`) یک کارت با ماشینِ حالتِ
...
- 🪙 **چند دارایی:** XAUUSD, DXY, EURUSD, AUDUSD — هر کدام کارتِ مستقلِ خودش.
...
| `GET /api/decision/:asset` | `asset` ∈ {XAUUSD,DXY,EURUSD,AUDUSD} | تصمیمِ یک دارایی |
