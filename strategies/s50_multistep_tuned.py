...
CONFIGS = [
    # پایهٔ برنده S50 (A): PF=1.301, WR=64.5, اکشن=4.88 — کمی کم برای ۵
    ("A پایه trail2.0    ", (0.8, 1.6, 2.8), (0.25, 0.25, 0.50), 2.0),
    # G: ۴ سطح، همان نیمهٔ دومِ بزرگ (0.5) اما سطحِ اول به دو ریزسطح شکسته
    #    تا اکشنِ بیشتر تولید شود بدونِ افزایشِ کسرِ زودبسته
    ("G ۴سطح ریز trail2.0", (0.7, 1.2, 1.9, 2.9), (0.15, 0.15, 0.20, 0.50), 2.0),
    ("H ۴سطح ریز trail2.5", (0.7, 1.2, 1.9, 2.9), (0.15, 0.15, 0.20, 0.50), 2.5),
    ("I ۵سطح ریز trail2.0", (0.6, 1.0, 1.5, 2.1, 3.0), (0.12, 0.13, 0.15, 0.20, 0.40), 2.0),
    ("J ۴سطح متوازن‌تر   ", (0.7, 1.3, 2.0, 3.0), (0.18, 0.17, 0.20, 0.45), 2.2),
]
