...
# ═══════════════════════════════════════════════════════════════════════════
# کانفیگِ نهاییِ تأییدشده (LIVE) — فقط XAUUSD M15.
# نتیجهٔ اسکنِ فلاتِ پایدار (۷ کانفیگِ PASS در همسایگی): RQS+ = 86.2،
# n=51، WR=60.8٪، PF=2.23، DD=4.2٪، p=0.010، هر ۴ پنجرهٔ walk-forward مثبت.
# مقادیر غیر-رند (اجتناب از اشتباه #۷): kmax=0.62, gap=0.22, sl=2.5, tp=3.3.
# M5/M30/H1/H4 و کلِ EURUSD: بدونِ لبهٔ پایدار (مختصِ طلا در تایم‌فریمِ M15).
# ═══════════════════════════════════════════════════════════════════════════
BEST = {
    'XAUUSD': {
        'M15': dict(kijun_atr_max=0.62, thick_min=0.32, kslope_min=0.0,
                    gap_min=0.22, da_min=0.25, rsi_min=45, rsi_max=90,
                    sl_mult=2.5, tp_mult=3.3, max_hold=56, side='long'),
    },
}
