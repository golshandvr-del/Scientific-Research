...
N_OPEN_FRAC = [0.08, 0.13, 0.21]      # کسری از روز که «ساعتِ اول» است
LATE_FROM = [0.62, 0.75]              # شروعِ پنجرهٔ پایانی (کسر از روز)
SPIKE_K = [0.9, 1.3, 1.8]             # leg1 ≥ spike_k × ATR
TIGHT_F = [0.9, 1.3]                  # mid_range ≤ tight_f × leg1
