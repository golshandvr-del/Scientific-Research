# -*- coding: utf-8 -*-
"""
S714 — نجاتِ استخری طبق بند ۵ پیش‌ثبت — دستورکار S431/S710/S711.
...
from strategies.s714_monday_range import ASSET, FAMILY, OUT, git_checkpoint  # noqa: E402

N_TRIALS_POOL = 5           # prereg §3: 4 + 1
SPLIT_FRAC = 0.70
