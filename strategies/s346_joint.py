...
# ------------------------------------------------------------------------------
# ⭐ دو ثابتِ حاصل از **اندازه‌گیریِ تجربیِ** این نشست (نه حدس)
# ------------------------------------------------------------------------------
# WR_FLOOR_REF : کفِ دروازهٔ G0 در RQS+ (WR ≥ ۶۰٪). عدد ۶۱ حاشیهٔ اطمینانِ ۱pp
#                دارد تا لایه‌ای که مرزی است، در داوریِ رسمی رد نشود.
WR_FLOOR_REF = 61.0
# LIFT_CEILING_PP : بیشترین بهبودِ WR که **انتخابِ زیرمجموعه** توانست ایجاد کند،
#                اندازه‌گیری‌شده روی هندسهٔ پرظرفیت با غربالِ کلِ ۴۰۱ ابزار:
#                    پایه n=29713 WR=47.32٪  →  فیلترشده n=238 WR=53.78٪
#                یعنی ≈ +۶.۵pp. با حاشیهٔ خوش‌بینانه ۸pp می‌گیریم تا هندسه‌ای
#                را زودهنگام حذف نکنیم. کاربرد: هر پایه‌ای که فاصله‌اش تا کف
#                بیش از این باشد، **ریاضیاً** غیرقابلِ نجات با فیلتر است ⇒ صرفِ
#                وقتِ محاسباتی روی آن اتلافِ منابع است.
LIFT_CEILING_PP = 8.0
