...
# ⚠️ اصلاحِ ثبت‌شده (پیش از قفل/تأیید): براکتِ ۵۰۰۰ پیپ در scan یک بار خورد —
# رالیِ آوریل ۲۰۲۵ طلا (+۵۰۰$/oz در ۱۰ روز؛ همان دم‌های ۱۱۸×). نیتِ پیش‌ثبت
# «هیچ سقف/کفی» بود ⇒ براکت به ±۲۰۰۰$/oz پهن شد تا پیاده‌سازی = نیت.
VIRTUAL_BRACKET_PIP = 20000.0                     # ±۲۰۰۰$/oz — هرگزفعال‌نشونده
