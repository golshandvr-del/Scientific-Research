...
FIRST_HOUR_BARS = {'M15': 4, 'M30': 2, 'H1': 1,
                   # H4: «ساعتِ اول» از خودِ TF قابلِ استخراج نیست (پیش‌ثبت §3)؛
                   # نسخهٔ «کفِ کندلِ اولِ روز» = ۱ کندل. هشدارِ صادقانه: در دادهٔ
                   # H4 وقفهٔ روزانهٔ بروکر (~۶۰min) درونِ گپِ عادیِ ۲۴۰min جذب
                   # می‌شود ⇒ مرزِ «روز» عملاً فقط آخرِ هفته دیده می‌شود و لنگر
                   # به «کندلِ اولِ هفته» تنزل می‌یابد — جداگانه گزارش می‌شود.
                   'H4': 1}
