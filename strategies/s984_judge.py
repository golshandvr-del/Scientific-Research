# -*- coding: utf-8 -*-
"""S984 — داورِ رسمیِ یک‌باره (طبق S984_ADDENDUM_FREEZE.md)
================================================================================
پیکربندیِ منجمد: XAUUSD-H8 · q=0.5 · main · SL_k=1.8 · RR=1.3
...
from strategies.s984_daily_open_reclaim_scan import atr_arr, reclaim_signals  # noqa: E402

ASSET, TF = 'XAUUSD', 'H8'
Q, SL_K, RR = 0.5, 1.8, 1.3
MAX_HOLD = 64
N_TRIALS = 456
OUT = 'results/_s984'
...
def main():
    ...
    print()
    print(R.format_rqs2('S984_DailyOpenReclaim_XAUUSD-H8', res))
