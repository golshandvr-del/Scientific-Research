# -*- coding: utf-8 -*-
"""
S642 — BopPressure — داوریِ نهاییِ holdout (مسیرِ C — فقط یک بار اجرا)
=======================================================================
پیش‌ثبت: results/S642_PREREG_BOP_PRESSURE_XAUUSD_PATHC.md (commit 1ddedc12)
...
def main():
    ...
    print('== S642 — داوریِ نهاییِ holdout · QQE 60/40 · {H3,H4,H6,H8,H12} · '
    ...
    if res is None:
        print('\n[S642] هیچ عضوِ معتبری نماند — استخر تهی. حکم: مرگ در H0.',
              flush=True)
    ...
    print('\n' + R.format_rqs2('S642-QQE-POOL', r), flush=True)

    out = dict(prereg='S642_PREREG_QQE_SATURATION_XAUUSD_PATHC.md@6ed3c39b',
