...
const ACCEPT_CONTRACT = {
  ...
  'XAUUSD-M15': { layers: 1, code: 'S344', rqs2: 89.0, note: 'Brooks trend-from-open · SHORT' },
  'XAUUSD-M30': { layers: 1, code: 'S312', rqs2: 87.7, note: 'رانشِ میانِ ماه · زمان-محور' },
  'XAUUSD-H1':  { layers: 1, code: 'S356', rqs2: 79.6, note: 'Brooks trend-resumption · علّی' },
