...
رد + ✅ مرحلهٔ ۳ (High-2 به‌عنوان فیلترِ تأیید روی S143) پذیرفته. **کارِ نیمه‌تمامِ
همپوشانیِ S168 اکنون بسته شد.** فصل‌های باقی‌ماندهٔ کتاب برای نشست‌های آینده:
**Signs of Strength (ف۱۹)، Two Legs (ف۲۰)، Trend from the Open (ف۲۳)،
